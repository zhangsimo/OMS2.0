...
*/
(function (g) {
  function x (a, b, c) { for (var d = 4, e = []; d--;)e[d] = Math.round(b.rgba[d] + (a.rgba[d] - b.rgba[d]) * (1 - c)); return 'rgba(' + e.join(',') + ')' } var r = g.Axis, y = g.Chart, s = g.Point, z = g.Pointer, l = g.each, v = g.extend, p = g.merge, n = g.pick, A = g.numberFormat, B = g.getOptions(), k = g.seriesTypes, q = B.plotOptions, t = g.wrap, u = g.Color, w = function () {}; B.mapNavigation = {buttonOptions: {align: 'right', verticalAlign: 'bottom', x: 0, width: 18, height: 18, style: {fontSize: '15px', fontWeight: 'bold', textAlign: 'center'}},
    buttons: {zoomIn: {onclick: function () { this.mapZoom(0.5) },
      text: '+',
      y: -32},
    zoomOut: {onclick: function () { this.mapZoom(2) }, text: '-', y: 0}}}; g.splitPath = function (a) { var b, a = a.replace(/([A-Za-z])/g, ' $1 '), a = a.replace(/^\s*/, '').replace(/\s*$/, ''), a = a.split(/[ ,]+/); for (b = 0; b < a.length; b++)/[a-zA-Z]/.test(a[b]) || (a[b] = parseFloat(a[b])); return a }; g.maps = {}; t(r.prototype, 'getSeriesExtremes', function (a) {
    ...
    var b = this.chart, c = b.plotWidth / b.plotHeight, d = this.isXAxis, e = b.xAxis[0]; a.call(this); if (b.options.chart.type === 'map' && !d && e.transA !== void 0) {
...
!1
    ...
    {type: 'map',
      ...
      useMapGeometry: !0,
      init: function (a) {
        var b = this, c = a.options.legend.valueDecimals, d = [], e, f, i, h, j, o, m; o = a.options.legend.layout === 'horizontal'; g.Series.prototype.init.apply(this, arguments); j = b.options.colorRange; if (h = b.options.valueRanges) {
          l(h, function (a) {
            f = a.from; i = a.to; e =
...
b
      ...
      translatePath: function (a) { var b = !1, c = this.xAxis, d = this.yAxis, e, a = [].concat(a); for (e = a.length; e--;) typeof a[e] === 'number' && (a[e] = b ? Math.round(c.translate(a[e])) : Math.round(d.len - d.translate(a[e])), b = !b); return a },
...
d.y
    ...
    var c = {endOnTick: !1,
        ...
        startOnTick: !1,
        tickWidth: 0,
        title: null}, d; d = a.series; a.series = null; a = p({chart: {type: 'map', panning: 'xy'}, xAxis: c, yAxis: p(c, {reversed: !0})}, a, {chart: {inverted: !1}}); a.series = d; return new g.Chart(a, b)
  }
})(Highcharts)
