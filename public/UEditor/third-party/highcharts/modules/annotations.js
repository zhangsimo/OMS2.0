(function (i, C) {
  function m (a) { return typeof a === 'number' } function n (a) { return a !== D && a !== null } var D, p, r, s = i.Chart, t = i.extend, z = i.each; r = ['path', 'rect', 'circle']; p = {top: 0, left: 0, center: 0.5, middle: 0.5, bottom: 1, right: 1}; var u = C.inArray, A = i.merge, B = function () { this.init.apply(this, arguments) }; B.prototype = {init: function (a, d) {
...
q.width
  ...
  destroy: function () { var a = this, d = this.chart.annotations.allItems, c = d.indexOf(a); c > -1 && d.splice(c, 1); z(['title', 'shape', 'group'], function (b) { a[b] && (a[b].destroy(), a[b] = null) }); a.group = a.title = a.shape = a.chart = a.options = null },
