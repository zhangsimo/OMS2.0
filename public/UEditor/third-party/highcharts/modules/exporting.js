...
d.sourceWidth,
      sourceHeight: c.sourceHeight || d.sourceHeight}})), c = o(this.options.exporting, c); f.post(c.url, {filename: c.filename || 'chart', type: c.type, width: c.width || 0, scale: c.scale || 2, svg: d})
  },
  print: function () {
    var c = this, a = c.container, d = [], b = a.parentNode, f = j.body, h = f.childNodes; if (!c.isPrinting) {
...
1)a.style.display = d[b]
  ...
  contextMenu: function (c, a, d, b, f, h, g) {
    var e = this, j = e.options.navigation, q = j.menuItemStyle, l = e.chartWidth, m = e.chartHeight, o = 'cache-' + c, i = e[o], s = D(f, h), v, w, n; if (!i) {
  ...
  addButton: function (c) {
    var a = this, d = a.renderer, b = o(a.options.navigation.buttonOptions, c), j = b.onclick, h = b.menuItems, g, e, k = {stroke: b.symbolStroke, fill: b.symbolFill}, q = b.symbolSize || 12; if (!a.btnCount)a.btnCount = 0; if (!a.exportDivElements) {
      a.exportDivElements =
[], a.exportSVGElements = []
    } if (b.enabled !== !1) {
