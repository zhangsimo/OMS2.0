...
i; i = q(l); n = b - i / 2; t = n + i; m > v ? (y = n = b - r / 2, B = t = b + r / 2) : l > v && (o = l, i = q(v), n = b - i / 2, t = n + i, l = v); w = ['M', y, m, 'L', B, m, t, l]; o && w.push(t, o, n, o); w.push(n, l, 'Z'); a.shapeType = 'path'; a.shapeArgs = {d: w}; a.percentage = x * 100; a.plotX = b; a.plotY = (m + (o || l)) / 2; a.tooltipPos = [b, a.plotY]; a.slice = z; a.half = u; h += x
    ...
    sortByAngle: z,
    drawDataLabels: function () { var a = this.data, g = this.options.dataLabels.distance, e, f, h, c = a.length, d, b; for (this.center[2] -= 2 * g; c--;)h = a[c], f = (e = h.half) ? 1 : -1, b = h.plotY, d = this.getX(b, e), h.labelPos = [0, b, d + (g - 5) * f, b, d + g * f, b, e ? 'right' : 'left', 0]; p.pie.prototype.drawDataLabels.call(this) }})
})(Highcharts)
