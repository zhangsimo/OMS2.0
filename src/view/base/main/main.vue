            ...
            <Modal v-model="screenshot"  fullscreen title="反馈意见">
              <div style="display: flex;border-bottom: 1px #cccccc solid">
                ...
                <div style=" flex-flow: row nowrap;">
                  ...
                  <Row>
                    <Col span="8" v-for="(item,index) in queryList" :key="index" style="text-align: center;margin-bottom: 5px">
                      <span :class="{'active':spanIndex.indexOf(index)>-1}" class="center" @click="add(item,index)">{{item.name}}</span>
                    </Col>
                  </Row>
                  <Input v-model="value17" maxlength="100" show-word-limit type="textarea" :rows="11" placeholder="请提出宝贵意见..." style="width: 100%"/>
                </div>
                <div>
        ...
        canvasMove(e) {
            if (this.canvasMoveUse) {
                ...
                if(this.info == 'pen'){
                    ...
                    canvasY = e.clientY - t.offsetTop + document.documentElement.scrollTop - 50;
