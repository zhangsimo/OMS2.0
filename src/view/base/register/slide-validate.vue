<template>
    <div class="drag">
        <div class="bg"
             :style="{width: bg.width + 'px', backgroundColor: bg.backgroundColor, transition: bg.transition}"></div>
        <div class="text" onselectstart="return false;" :style="{color: text.color}">{{text.innerHTML}}</div>
        <div class="btn"
             :style="{left: btn.left + 'px', color: btn.color, borderColor: btn.borderColor, transition: btn.transition}">
