<template>
    <div class="bank-box">
      <div class="bank-header">
        ...
        <Button class="mr10 w90" @click="setAuit" v-if="oneBankList.isInit == 0"><span class="center"><Icon custom="iconfont iconshenheicon icons" />审核</span></Button>
      ...
      <div class="bank-center">
        ...
        <vxe-table
          ...
          <vxe-table-column field="accountTypeId" title="账户类型" :formatter="getType">
          </vxe-table-column>
...
<script>
  import {getBankList , getAudit ,saveAudit} from '@/api/system/systemSetting/setBank'
    export default {
        name: "setBank",
        data(){
