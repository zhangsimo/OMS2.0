<template>
  <main class="inventory">
    ...
    <div style="line-height:45px">
      <Button class="mr10 w90" @click="insertEvent(-1)" v-show="oneWarehouse.auditSign == 0">
        <Icon type="md-add"/>
        新增
      </Button>
      ...
      <Button class="mr10 w90" type="default" v-show="oneWarehouse.auditSign == 0 && oneWarehouse.hasOwnProperty('id')"
              @click="check">
    ...
    >
      ...
      <vxe-table-column title="数量金额信息">
        <vxe-table-column field="enterQty" title="数量"
