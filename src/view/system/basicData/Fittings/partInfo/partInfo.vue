<template>
  <div>
    <Modal v-model="proModal" title="配件资料" width="800" :mask-closable="false" @on-visible-change="visible">
      ...
      >
        ...
        <TabPane label="包装规格" tab="partInfoTab" name="active2">
          <div class="pb10">
        ...
        <TabPane label="关联配件" tab="partInfoTab" name="active3" class="con-warp">
          <div class="partCheck-hd">
            ...
            >
                <Option v-for="(item2,index2) in item.children"  :value="item2.code" :key="index2">{{item2.name}}</Option>
            </Select>
