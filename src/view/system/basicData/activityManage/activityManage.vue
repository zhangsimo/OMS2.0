    ...
    <section class="oper-box">
      <div class="oper-top flex" v-if="tabValue === 'name2'">
        <div class="wlf">
          ...
          <div class="db mr10">
            <span>创建人：</span>
            <Input ref="getDataObj" style="width:200px" class="mr10" placeholder="请输入创建人"
                   v-model="getDataObj.createUname"/>
          </div>
          <div class="db mr10">
            <span>内码/编码/名称/OE码：</span>
            <Input ref="getDataObj" style="width:200px" class="mr20" placeholder="请输入内码/编码/名称/OE码"
                   v-model="getDataObj.partName"/>
          </div>
          <div class="db">
      ...
      <Tabs value="name1" :animated="false" type="card" @on-click="handleClickTab">
        <TabPane label="活动申请信息" name="name1">
          ...
          >
            ...
            <vxe-table-column field="group0" title="申请主表信息" align="left" key="mainIfo">
              <vxe-table-column field="orgname" title="申请分店"></vxe-table-column>
              <vxe-table-column field="applyId" title="申请单号"></vxe-table-column>
              <vxe-table-column field="isVenderText" title="是否厂家提供"></vxe-table-column>
              ...
              <vxe-table-column field="state" title="审批状态"></vxe-table-column>
              <vxe-table-column field="isCancelFlowText" title="是否为取消申请"></vxe-table-column>
          ...
          >
            ...
            <vxe-table-column field="orgname" title="指定公司"></vxe-table-column>
            <vxe-table-column field="partCode" title="配件编码"></vxe-table-column>
            <vxe-table-column field="partName" title="配件名称"></vxe-table-column>
            <vxe-table-column field="partBrandName" title="品牌"></vxe-table-column>
            <vxe-table-column field="num" title="活动数量"></vxe-table-column>
            <vxe-table-column field="price" title="活动单价"></vxe-table-column>
            <vxe-table-column field="isGiftBoolean" title="是否赠送" width="100">
              <template v-slot="{ row }">
                <Checkbox disabled v-model="row.isGiftBoolean"></Checkbox>
              </template>
            </vxe-table-column>
            <vxe-table-column field="oemCode" title="OEM码"></vxe-table-column>
            <vxe-table-column field="carModelName" title="车型"></vxe-table-column>
            <vxe-table-column field="activityId" title="活动ID"></vxe-table-column>
            <vxe-table-column field="remark" title="备注"></vxe-table-column>
            <vxe-table-column field="beginDate" title="开始日期"></vxe-table-column>
            <vxe-table-column field="endDate" title="结束日期"></vxe-table-column>
            <vxe-table-column field="createUname" title="创建人"></vxe-table-column>
            <vxe-table-column field="createTime" title="创建日期"></vxe-table-column>
          </vxe-table>
        </TabPane>
        ...
        <TabPane label="过期活动" name="name3">
          ...
          >
            ...
            <vxe-table-column field="num" title="活动数量"></vxe-table-column>
            <vxe-table-column field="price" title="活动单价"></vxe-table-column>
            <vxe-table-column field="isGift" title="是否赠送" width="100">
              <template v-slot="{ row }">
                <Checkbox disabled v-model="row.isGiftBoolean"></Checkbox>
              </template>
            </vxe-table-column>
  ...
  export default {
    ...
    data() {
      return {
        ...
        data5: [],
        data6: [],
        loading1: false,//活动申请信息loading
        loading2: false, //活动信息loading
        loading3: false,//过期活动loading
        loading4:false,//活动申请信息下册表格loading
        page: 1,
        total: 0,
        size: 20,
        pageSize: 10,
    ...
    methods: {
      ...
      getActivity() {
        ...
        getActivityList(this.getDataObj).then(res => {
          this.data2 = res.data.content.map(el => {
            el.isGift == 0 ? el.isGiftBoolean = false : el.isGiftBoolean = true;
            return el;
          });
          ;
      ...
      handleSummary({columns, data}) {
        return [
          columns.map((column, columnIndex) => {
            ...
            if (['applyId', 'id'].includes(column.property)) {
              return data.length
            }
            return null;
          })]
