  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        billTypeId: [
          { required: true, message: "不能为空", trigger: "change",type: 'string' }
        ],
        ...
        contactorTel: [
          { required: true, validator: validatePhone, trigger: "blur",type: 'string' }
        ],
        cityId: [{ required: true, message: "不能为空", trigger: "change",type: 'string' }],
        supplierTypeFirst: [
          { required: true, message: "不能为空", trigger: "change",type: 'string' }
        ],
        supplierTypeSecond: [
