      ...
      <Row>
        ...
        <Col span="8">
          ...
          <FormItem label="临时额度开始时间:">
            <DatePicker
              :value="customerDetails.tempStart"
              format="yyyy/MM/dd"
              :options="dateOptions"
              style="width: 150px"
              disabled
        ...
        <Col span="8">
          <FormItem label="调整后固定额度:">
            <Input
              :value="+customerDetails.applyQuota+customerDetails.creditLimit || 0"
              style="width: 150px"
              disabled
            ></Input>
          </FormItem>
          <FormItem label="调整后临时额度:">
            <Input
              :value="+customerDetails.tempQuota + customerDetails.beforeAdjustTempQuota || 0"
              style="width: 150px"
              disabled
            ></Input>
          </FormItem>
      ...
      <Row>
        ...
        <Col span="8">
          <FormItem label="调整后累计额度:">
            <Input
              :value="(+customerDetails.applyQuota+customerDetails.creditLimit) + (+customerDetails.tempQuota + customerDetails.beforeAdjustTempQuota)"
              style="width: 150px"
              disabled
            ></Input>
          </FormItem>
  ...
  data() {
    return {
      dateOptions: {
        disabledDate(date) {
          return (
            Date.now() - 86400 * 1000 > date ||
            date.valueOf() > Date.now() + 86400 * 1000 * 29
          );
        }
      },
      value1: new Date(),
