    ...
    <Modal v-model="subjectModelShowassist"  title="选择辅助核算" class="funtPa" width="750" @on-ok="confirmFuzhu" @on-visible-change="showOrhideModel">
      <Form :value="AssistAccounting">
        <Tabs type="card" v-model="currTab">
          ...
          <TabPane label="部门" name="department" disabled>
          ...
          <TabPane label="其他辅助核算" name="Other" disabled>
            <div class="Other">
              <div class="OtherLeft">
                <ul>
                  <li
        ...
        <div class="fund" v-if="Classification === 1">
          <Form
            ref="formDynamic"
            :model="formDynamic"
        ...
        <div class="fund" v-else-if="Classification === 2">
