      ...
      <div class="inner-box">
        <Split v-model="split1">
          <div slot="left" v-show="!rightValue">
            ...
            <div style="line-height: 36px">
              ...
              <Tooltip :content="leftValue ? '缩小' : '放大'" placement="bottom">
                <Icon @click.native="handleChangeLeft"
                      :custom="leftValue ? 'iconfont iconsuoxiaoicon icons' : 'iconfont iconkuodaicon icons'"
                      style="cursor: pointer;"></Icon>
              </Tooltip>
            </div>
            <accountNoWriteTable :table-data="accountNoWriteData" :loading="accountNoWriteLoading"
                                 @currEvent="accountNoWriteChange"></accountNoWriteTable>
            <Page
              show-sizer
              show-total
              show-elevator
          ...
          <div slot="right" style="height:100%" v-show="!leftValue">
            <Tabs type="card">
              <TabPane label="本店待认领款">
                <div class="card">
                  ...
                  <br/>
                  <Button class="mt10 ml10" v-has="'revoke'" @click="distributionDelete" :disabled="cancelDis">撤销分配
                  </Button>
            ...
            <otherPaymentClaim ref="otherPaymentClaim" :accrued="claimedSubjectList"
                               :selectItem="selectItem"></otherPaymentClaim>
            <!-- 转应收应付 accrued-->
