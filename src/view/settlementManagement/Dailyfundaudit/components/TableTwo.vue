...
<!--        </vxe-table-column>-->
      ...
      <vxe-table-column field="remarks" show-overflow='title' title="备注" min-width="80"></vxe-table-column>
    </vxe-table>
  </div>
</template>
...
<script>
  ...
  methods: {
    ...
    async getList(params){
      let res=await api.table2(params)
      if(res.code===0){
        this.$parent.$parent.$parent.tableData2=res.data.content || [];
