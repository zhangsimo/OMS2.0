<template>
  <div>
    ...
    >
      ...
      <vxe-table-column field="remarks" show-overflow='title' title="备注" min-width="100"></vxe-table-column>
    </vxe-table>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      async getList(params){
        let res=await api.table5(params)
        if(res.code===0){
          this.$parent.$parent.$parent.tableData5=res.data.content || [];
