                ...
                <template v-slot="{ row }">
                  <ul class="list">
                    <li
                      ...
                      class="flex"
                    >
                      <span class="listChild">{{ item.receiver }}</span>
                    </li>
                  </ul>
                </template>
              </vxe-table-column>
                ...
                <template v-slot="{ row }">
                  <ul class="list">
                    <li
                      ...
                      class="flex"
                    >
                      <span class="listChild">{{ item.receiveDate }}</span>
                    </li>
                  </ul>
                </template>
              </vxe-table-column>
                ...
                <template v-slot="{ row }">
                  <ul class="list">
                    <li
                      ...
                      class="flex"
                    >
                      <span class="listChild">{{ item.receiveRemark }}</span>
                    </li>
                  </ul>
                </template>
              </vxe-table-column>
                ...
                <template v-slot="{ row }">
                  <ul class="list">
                    <li
                      ...
                      class="flex"
                    >
                      <span class="listChild">{{ item.receiveAuditor }}</span>
                    </li>
                  </ul>
                </template>
              </vxe-table-column>
                ...
                <template v-slot="{ row }">
                  <ul class="list">
                    <li
                      ...
                      class="flex"
                    >
                      <span class="listChild">{{ item.receiveAuditDate }}</span>
                    </li>
                  </ul>
                </template>
              </vxe-table-column>
