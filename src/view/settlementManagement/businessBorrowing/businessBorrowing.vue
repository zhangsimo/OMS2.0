  ...
  <div class="content-oper content-oper-flex">
    <section class="oper-box">
      ...
      <div class="mt10 mb10">
        ...
        <Button class="ml10" @click="revokeCollection(1)">因公借支核销撤回</Button>
        <Button class="ml10" @click="revokeCollection(2)">因公借支收回撤回</Button>
        ...
        <div class="box mb10">
          ...
          >
            <vxe-table-column title="基本信息">
              ...
              <vxe-table-column field="serviceId" title="因公借支申请单号"></vxe-table-column>
            ...
            <vxe-table-column title="金额信息">
              ...
              <vxe-table-column field="" title="因公借支付款单号"></vxe-table-column>
              <vxe-table-column field="" title="因公借支已认领金额"></vxe-table-column>
              <vxe-table-column field="" title="因公借支核销单号"></vxe-table-column>
              <vxe-table-column field="" title="因公借支核销金额"></vxe-table-column>
              <vxe-table-column field="" title="因公借支收回单号"></vxe-table-column>
              <vxe-table-column field="remainingAmt" title="因公借支收回金额"></vxe-table-column>
              <vxe-table-column field="remainingAmt" title="因公借支未核销余额"></vxe-table-column>
            </vxe-table-column>
