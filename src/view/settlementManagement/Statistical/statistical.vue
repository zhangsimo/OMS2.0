  ...
  >
    ...
    <div class="mt15">
      ...
      >
        ...
        ></vxe-table-column>
        <!--        fixed="left"-->
        <vxe-table-column field="bankName" title="开户行" width="150">
          <!--          fixed="left"-->
        </vxe-table-column>
        <vxe-table-column field="mateAccountName" title="对应科目" width="150">
          <!--          fixed="left"-->
        </vxe-table-column>
        <vxe-table-column
        ...
        <vxe-table-column field="recoveryMoney" title="收回应收" width="100">
        </vxe-table-column>
        <vxe-table-column
        ...
        <vxe-table-column field="saleMoney" title="销售收入小计" width="100">
        </vxe-table-column>
        <vxe-table-column
          field="refundMoney"
          title="税费返还等财政补助"
        ...
        <vxe-table-column field="otherMoney" title="其他收入" width="100">
        </vxe-table-column>
        <vxe-table-column field="keepAccountsMoney" title="走账" width="100">
        </vxe-table-column>
        <vxe-table-column
        ...
        <vxe-table-column field="dayMoney" title="本日资金收入小计" width="150">
        </vxe-table-column>
        <vxe-table-column field="payCopeMoney" title="付出应付" width="100">
        </vxe-table-column>
        <vxe-table-column
        ...
        <vxe-table-column field="taxesMoney" title="上缴税金支出" width="100">
        </vxe-table-column>
        <vxe-table-column
        ...
        <vxe-table-column field="takeAccountMoney" title="走账款" width="100">
        </vxe-table-column>
        <vxe-table-column field="procedureFeeMoney" title="手续费" width="100">
        </vxe-table-column>
        <vxe-table-column field="deathMoney" title="因公借支" width="100">
        </vxe-table-column>
        <!--        <vxe-table-column-->
  ...
  methods: {
    ...
    async getShop() {
      ...
      if (res.code === 0) {
        ...
        this.$nextTick(() => {
          this.BranchstoreId =
            this.$store.state.user.userData.currentShopId || "";
        });
    ...
    getExport() {
      ...
      for (var i in data) {
       ...
       location.href = api.getPayablesExportwu(params)
    },
    // 查询
    async query() {
      let params = {
