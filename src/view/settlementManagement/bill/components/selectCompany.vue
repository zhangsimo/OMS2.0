<template>
  <div>
    <Modal v-model="searchPartLayer" title="供应商" width="1000">
      <div class="partCheck-hd">
        <Input class="w150 mr10" v-model="fullName" placeholder="名称"/>
        <Input class="w200 mr10" v-model="code" placeholder="编码"/>
        <Input class="w150 mr10" v-model="contactorTel" placeholder="电话"/>
        │
