  ...
  >
    <div class="clearfix">
      ...
      <vxe-table
        ...
        <vxe-table-column field="expenseClaimAmount" title="预收款认领金额"></vxe-table-column>
        <vxe-table-column field="writeOffReceiptNo" title="预收款核销金额"></vxe-table-column>
        <vxe-table-column field="writeOffAmount" title="预收款支出金额"></vxe-table-column>
        <vxe-table-column field="paymentBalance" title="预收款支出已认领金额"></vxe-table-column>
        <vxe-table-column field="paymentBalance" title="预收款余额"></vxe-table-column>
      </vxe-table>
    </div>
    <div slot='footer'>
