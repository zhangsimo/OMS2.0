...
<script>
  import account from "@/view/settlementManagement/bill/Popup/accountregistration";
  import idDetailed from "../../../settlementManagement/Expensereimbursement/components/components/idDetailed";
  //新增 开票信息 弹框
  ...
  export default {
      ...
      return {
        ...
        account: [
          ...
          },
          {
            ...
            className: "tc",
            render: (h, params) => {
              return h("span", params.row.reimbursementAmount.toFixed(2));
            }
          },
          {
            title: "报销已认领金额",
            key: "expenseClaimAmount",
            className: "tc",
            render: (h, params) => {
              return h("span", params.row.expenseClaimAmount.toFixed(2));
            }
          },
          {
            title: "因公借支核销金额",
            ...
            className: "tc",
            render: (h, params) => {
              return h("span", params.row.writeOffAmount.toFixed(2));
            }
          },
          {
            title: "报销未核销金额",
            ...
            className: "tc",
            render: (h, params) => {
              return h("span", params.row.paymentBalance.toFixed(2));
            }
          },
          {
            title: "已收进项金额",
    ...
    methods: {
      ...
      //获取 发票销售方名称数组
      async getInvoiceSellerList(params) {
