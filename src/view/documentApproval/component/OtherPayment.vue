<template>
  <Modal v-model="model" title="其他付款 申请单" width="1200px">
    <div class="bigbox">
      <div class="clearfix">
        <div class="fr">
      ...
      >
            ...
            <Row>
              ...
              <Col span="12">
                ...
                >
                  <DatePicker
                    type="date"
                    v-model="formInline.paymentTerm"
                    style="width: 100%"
                    :disabled="modelType"
                  ></DatePicker>
                </FormItem>
        ...
        <Button
          class="mb10"
          @click="SelectTheDocuments"
          :disabled="modelType || list.type == 5"
          >选择单据</Button
        >
        <vxe-table
          class="mt10"
        ...
        >
          ...
          ></vxe-table-column>
          <vxe-table-column
            field="paymentApplicationAmount"
            title="其他付款申请金额"
          ></vxe-table-column>
          <vxe-table-column
