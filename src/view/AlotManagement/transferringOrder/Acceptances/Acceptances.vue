      ...
      <section class="oper-box">
        <div class="oper-top flex">
          <div class="wlf">
            ...
            <div class="db flex">
              <span>开始日期：</span>
              <DatePicker @on-change="selectDate" @on-clear="aaa" type="daterange" placement="bottom-start" placeholder="选择日期"
                          class="w200 mr20">
              </DatePicker>
            </div>
            <div class="db mr10">
            ...
            <div class="db">
              ...
              <Select v-model="productName" class="w100 mr10">
                <Option v-for="item in purchaseNameArr" :value="item.id" :key="item.id">{{item.fullName}}</Option>
              </Select>
