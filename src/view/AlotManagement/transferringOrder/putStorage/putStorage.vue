                  ...
                  <div slot="right" class="con-split-pane-right pl5 goods-list-form">
                    ...
                    <div v-if="showit" class="clearfix purchase" ref="planForm">
                      <Form inline :show-message="false" ref="formPlan" :label-width="120">
                        ...
                        <FormItem label="入库单号：" prop="planOrderNum">
                          <Input class="w160" :disabled="Leftcurrentrow.status.value !== 0" :value="Leftcurrentrow.serviceId"></Input>
                        </FormItem>
                      </Form>
                    </div>
                    ...
                    >
                      ...
                      <vxe-table-column field="hasInQty" :edit-render="{name: 'input'}" title="入库数量" width="100">
                      </vxe-table-column>
                      <vxe-table-column field="storeShelf" :edit-render="{name: 'input'}" title="入库仓位" width="100">
                      </vxe-table-column>
