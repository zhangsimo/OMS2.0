<template>
  <div>
    <div class="content-oper content-oper-flex">
          ...
          <div class="con-split" ref="paneLeft">
            <Split v-model="split1" min="200" max="500">
              <div slot="left" class="con-split-pane-left">
                <div class="pane-made-hd">调入退回申请列表</div>
                <Table
              ...
              <div slot="right" class="con-split-pane-right pl5 goods-list-form">
                ...
                <div class="clearfix purchase" ref="planForm">
                  ...
                  >
                    ...
                    <FormItem label="申请退回日期：" prop="planDate" class="fs12 ml50">
                      <Date-picker
                    ...
                    <FormItem label="退回申请单号：" prop="planOrderNum" class="ml50">
                ...
                >
                  ...
                  <vxe-table-column field="item1" title="配件编码" width="100"></vxe-table-column>
                  <vxe-table-column field="item2" title="配件名称" width="100"></vxe-table-column>
                  <vxe-table-column field="item3" title="品牌" width="100"></vxe-table-column>
                  <vxe-table-column field="item4" title="申请退回数量" width="100"></vxe-table-column>
                  <vxe-table-column
                    field="item5"
                    title="备注"
                    ...
                    width="100"
                  ></vxe-table-column>
                  <vxe-table-column field="item6" title="品牌车型" width="100"></vxe-table-column>
                  <vxe-table-column field="item7" title="单位" width="100"></vxe-table-column>
                  <vxe-table-column field="item8" title="OE码" width="100"></vxe-table-column>
                  <vxe-table-column field="item9" title="规格" width="100"></vxe-table-column>
                  <vxe-table-column field="item10" title="方向" width="100"></vxe-table-column>
                </vxe-table>
                <div ref="planPage">
                  <Page
                    size="small"
      ...
      ></select-supplier>
      <!-- 提交提示 -->
      <Modal v-model="showUp" title="提示" @on-ok="upOk" @on-cancel="upCancel">
        <p>是否确定提交</p>
      </Modal>
      <!-- 作废提示 -->
