<template>
    <div style="height:100%">
      ...
      <getDate class="mr10"  @quickDate="getvalue" ></getDate>
        ...
        <Button class="mr10 w90" @click="setSave" :disabled="orderlistType != 0"><span class="center"><Icon custom="iconfont iconbaocunicon icons"/>保存</span></Button>
        <!-- <Button class="mr10" @click="sumbit" :disabled="orderlistType != 0"><i class="iconfont mr5 iconxuanzetichengchengyuanicon"></i>提交</Button> -->
        <Button class="mr10" @click="setStockOut" :disabled="orderlistType != 0"><i class="iconfont mr5 iconxuanzetichengchengyuanicon"></i>出库</Button>
        ...
        <Button class="mr10" @click="setCancellation" :disabled="orderlistType != 0"><Icon type="md-close" size="14" /> 作废</Button>
        ...
        <div class="demo-split">
          <Split v-model="split1">
            <div slot="left" class="demo-split-pane">
              <OrderLeft ref="leftorder" :queryTime="queryTime" :orderType ='orderType' @getOneOrder = 'getOrder' :changeLeftList="changeLeft"></OrderLeft>
            </div>
