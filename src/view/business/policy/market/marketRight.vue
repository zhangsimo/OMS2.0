  ...
  <div style="height: 100%;">
    <Form inline :show-message="false" ref="formPlan" :model="formPlan" :label-width="100">
      <div class="pane-made-hd">
        ...
        <span class="titler mr10">{{ 20000 |priceFilters}}</span>
        <span class="titler mr5">临时额度:</span>
        <span class="titler mr10">{{ 10000 |priceFilters}}</span>
        <span class="titler mr5">可用余额:</span>
        <span class="titler mr5">{{ 10000 |priceFilters}}</span>
      </div>
      <div class="clearfix purchase" ref="planForm">
        <FormItem label="客户：">
          <Row style="width: 310px">
            <Input style="width: 240px" v-model="formPlan.asd" disabled></Input>
            <Button class="ml5" size="small" type="default" @click="openAddCustomer">
    ...
    <div class="tableBox">
      ...
      >
        ...
        <vxe-table-column field="name" title="仓库">
          <Select>
            <Option value="1">仓库</Option>
          </Select>
        </vxe-table-column>
        <vxe-table-column field="role" title="仓位" :edit-render="{name: 'input'}"></vxe-table-column>
