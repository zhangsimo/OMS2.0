  ...
  <Modal v-model="addressShow" title="选择客户"  width="1000" class="modalBox">
    <div>
      <header class="titleHeader">
        ...
        <Cascader :data="clientType" @on-change="getType" change-on-select placeholder="请选择类型" class="mr10 w200" style="display: inline-block"></Cascader>
          ...
          <Split v-model="split1">
            ...
            <div slot="right" class="demo-split-pane">
              ...
              <Page size="small" :total="page1.total" :page-size="page1.size" :current="page1.num"   :page-size-opts="page1.sizeOpts"
                    show-sizer show-total   @on-change="selectNum" @on-page-size-change="selectPage"
