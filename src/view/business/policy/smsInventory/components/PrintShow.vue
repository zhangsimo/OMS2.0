      ...
      <div class="titler">
        <Row style="border: 1px #000000 solid;color:#000;">
          ...
          <Col span="8" class="pl10" >
            <p style="font-weight:600;font-size: 12px">盘点单</p>
        ...
        <Row style="border: 1px #000000 solid;border-top: none;color:#000;">
          <Col span="16" class="pl10" style="border-right: 1px #000000 solid">
            <p><span style="font-size: 12px">地址:</span> <span style="font-size: 12px">{{onelist.orgAddr}}</span></p>
            <p><span style="font-size: 12px">电话:</span><span style="font-size: 12px">{{onelist.orgTel}}</span></p>
          </Col>
          <Col span="8" class="pl10" >
            <p><span style="font-size: 12px">订单日期:</span><span style="font-size: 12px">{{onelist.createTime}}</span></p>
            <p>
