            ...
            <div slot="right" class="con-split-pane-right pl5 goods-list-form">
              ...
              <div class="clearfix purchase" ref="planForm">
                <Form
                  ...
                  :rules="ruleValidate"
                >
                  <FormItem label="入库单号：" prop="storeId">
                    <Input
                  ...
                  <FormItem label="关联单号：" prop="orderMan">
                    <Input
                      v-model="formPlan.serviceId"
                      class="w160"
                      value="YCSDFD839239320"
                  ...
                  <FormItem label="创建日期：" prop="checkDate">
                    <DatePicker
                  ...
                  <FormItem label="入库仓库：" prop="serviceId">
                    <Input
                      v-model="formPlan.serviceId"
                      class="w160"
                      value="YCSDFD839239320"
                  ...
                  <FormItem label="供应商：" prop="serviceId">
                    <Input
                      v-model="formPlan.serviceId"
                      class="w160"
                      value="YCSDFD839239320"
                  ...
                  <FormItem label="备注：" prop="serviceId">
                    <Input
                      v-model="formPlan.serviceId"
                      class="w160"
                      value="YCSDFD839239320"
                  ...
                  <FormItem label="来源：" prop="serviceId">
                    <Input
                      v-model="formPlan.serviceId"
                      class="w160"
                      value="YCSDFD839239320"
