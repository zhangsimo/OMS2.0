          ...
          <Split v-model="split1" min="200" max="500" @on-moving="getDomHeight">
            ...
            <div slot="right" class="con-split-pane-right pl5 goods-list-form">
              ...
              >
                ...
                <vxe-table-column field="unsalableQty" title="滞销库存" width="100"></vxe-table-column>
                <vxe-table-column
                  field="orderQty"
                  title="计划采购数量"
                ...
                <vxe-table-column title="不含税金额" width="100">
                  <template v-slot="{ row }">{{ row.noTaxPrice.toFixed(2)*row.orderQty |priceFilters}}</template>
                </vxe-table-column>
