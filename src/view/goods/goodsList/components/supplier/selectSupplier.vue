  ...
  <div>
    <Modal v-model="searchPartLayer" :title="headerTit" width="1000">
      <div class="partCheck-hd">
        <Input class="w100 mr10" v-model="fullName" placeholder="名称"></Input>
        <Input class="w100 mr10" v-model="code" placeholder="编码"></Input>
        <Input class="w100 mr10" v-model="contactorTel" placeholder="电话"></Input>
        │
