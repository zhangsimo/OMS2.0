      ...
      <div class="titler">
        <Row style="border: 1px #000000 solid">
          <Col span="16" class="pl10">
            <h5
              style="font-size: 20px;line-height: 44px;color:#000;"
            >
              {{ onelist.orgName }}
            </h5>
          </Col>
          <Col span="8" class="pl10" style="color:#000;">
            <p style="font-weight: 600;font-size: 12px">采购订单:</p>
        ...
        <Row style="border: 1px #000000 solid;border-top: none;color:#000;">
          ...
          <Col span="4" class="pl10" style="border-right: 1px #000000 solid">
            ...
            <p>
              <span style="font-size: 12px">票据类型:</span><span style="font-size: 12px">{{ onelist.billTypeName }}</span>
            </p>
          </Col>
