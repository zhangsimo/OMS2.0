      ...
      <div class="oper-top flex">
        <div class="wlf wlf-center">
          ...
          <div class="db">
            ...
            >
              <i class="iconfont mr5 iconziyuan2"></i>提交入库
            </Button>
          </div>
          <div class="db">
          ...
          <div class="db">
            <Button @click="showStatus" class="mr10" :disabled="hideSp" v-has="'approval'">
            ...
            <div slot="right" class="con-split-pane-right pl5 goods-list-form">
              ...
              <div class="clearfix purchase" ref="planForm">
                ...
                >
                  ...
                  <FormItem class="form-Item" label="预付款：" prop="advanceAmt">
                    <Input class="w160" v-model="formPlanmain.advanceAmt" :disabled="isInput" />
                  </FormItem>
              ...
              <div class="flex plan-cz-btn" ref="planBtn">
                <div class="clearfix">
                  ...
                  <div class="fl mb5">
                    <Button size="small" @click="down" class="mr10">
