<template>
  <div>
    <Modal v-model="searchPartLayer" title="往来单位" width="1000">
      <div class="partCheck-hd">
        <Input class="w150 mr10" v-model="partName" placeholder="名称" />
        <Input class="w150 mr10" v-model="partName" placeholder="编码" />
        <Input class="w150 mr10" v-model="partName" placeholder="电话" />
