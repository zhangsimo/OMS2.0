  ...
  <div>
    <Modal v-model="searchPartLayer" :title="headerTit" width="1000">
      <div class="partCheck-hd">
        ...
        <Input class="w150 mr10" v-model="fullName" ref="focusInput" placeholder="名称" @input="search"/>
        <Input class="w150 mr10" v-model="coding" ref="coding" placeholder="编码"/>
        <Input class="w150 mr10" v-model="phone" ref="phone" placeholder="电话"/>
