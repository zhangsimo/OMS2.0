        ...
        <table class="gridtable">
          ...
          <tr>
            ...
            <th colspan="4" style="text-align: left;">
              <p style="font-size: 15px;font-weight: 600;padding:0">向供应商理赔登记单:</p>
          ...
          <tr style="padding-top: 0px;margin-top: 0px;">
            <th colspan="6" style="font-weight: 400;text-align: left;">
              <div><span
                style="font-size: 12px;">地址:{{ onelist.orgStreetAddress }}</span></div>
              <div><span style="font-size: 12px;">电话:{{ onelist.orgContactorTel }}</span></div>
            </th>
          ...
          <tr style="border-top:1px solid #000;">
            <th colspan="4"
              ...
              <div>
                ...
                style="font-size: 12px">{{ onelist.guestStreetAddress }}</span>
              </div>
            </th>
            <th colspan="3"
                style="line-height: 12px;font-weight: 400;text-align: left;border-top:1px solid #000;border-right:1px solid #000;">
