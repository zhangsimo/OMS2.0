<template>
  <div id="printBoxBig">
    <div id="printBoxPickup" style="border: 1px solid #000c17;">
      <div class="titler">
        <table class="gridtable">
          ...
          <tr>
            ...
            <th colspan="5" style="text-align: left;">
              <p style="font-size: 15px;font-weight: 600;padding:0">销售订单:</p>
...
<script lang="ts">
  ...
  import {getPrintPickUpList} from "@/api/salesManagment/salesOrder";//销售订单
  ...
  export default class print extends Vue{
    ...
    private print() {
      ...
      if (!iframe) {
        let el:any = document.getElementById("printBoxPickup");
    ...
    private async openModal(data){
      // @ts-ignore
      let res:any=await getPrintPickUpList(data);
      if(res.code===0){
...
<style type="less">
  ...
  #printBoxPickup::-webkit-scrollbar {
    display: none;
  }
  ...
  #printBoxPickup.ivu-modal-wrap.ivu-modal-content.ivu-modal-close {
