      ...
      <div class="titler">
        <Row style="border: 1px #000000 solid;color:#000;">
          ...
          <Col span="8" class="pl10" >
            <p style="font-weight: 600;font-size: 12px">预售单:</p>
        ...
        <Row style="border: 1px #000000 solid;border-top: none;color:#000;">
          <Col span="10" class="pl10" style="border-right: 1px #000000 solid">
            ...
            <p><span style="font-size: 12px">地址:</span> <span style="font-size: 12px">{{onelist.guestAddr}}</span></p>
          </Col>
          <Col span="4" class="pl10" style="border-right: 1px #000000 solid">
            ...
            <p><span style="font-size: 12px">票据类型:</span><span style="font-size: 12px">{{onelist.billType}}</span></p>

          </Col>
          <Col span="10" class="pl10">
            <p><span style="font-size: 12px">联系电话:</span><span style="font-size: 12px">{{onelist.contactorTel}}</span></p>
            <p><span style="font-size: 12px">结算方式:</span><span style="font-size: 12px">{{onelist.settleType}}</span></p>
          </Col>
        </Row>
        <Row style="border: 1px #000000 solid;border-top: none;color:#000;">
...
<!--         <Table resizable  size="small" style="margin: 0 auto" width="990"  border :columns="columns2" :data="details" class="ml10"></Table>-->
        <Row style="border: 1px #000000 solid;color:#000;">
...
<script>
  import {getPrint} from "_api/salesManagment/presell.js";
