      ...
      <div class="titler">
        <Row style="border: 1px #000000 solid;color:#000;">
          ...
          <Col span="8" class="pl10" >
            <p style="font-weight: 600;font-size: 12px">销售退货单:</p>
        ...
        <Row style="border: 1px #000000 solid;border-top: none;color:#000;">
          <Col span="10" class="pl10" style="border-right: 1px #000000 solid">
            ...
            <p><span style="font-size: 12px">地址:</span> <span style="font-size: 12px">{{onelist.guestAddress}}</span></p>
          </Col>
          <Col span="4" class="pl10" style="border-right: 1px #000000 solid">
            <p><span style="font-size: 12px">联系人:</span> <span style="font-size: 12px">{{onelist.guestContactor}}</span></p>
            <p><span style="font-size: 12px">票据类型:</span><span style="font-size: 12px">{{onelist.billTypeName}}</span></p>

          </Col>
          <Col span="10" class="pl10">
            <p><span style="font-size: 12px">联系电话:</span><span style="font-size: 12px">{{onelist.guestTel}}</span></p>
            <Row>
              <Col span="12">
                <p>
...
<script>
  import {getPrint} from "_api/salesManagment/sellReturn.js";
                ...
                columns2: [
                    ...
                    },
                  {
                    ...
                    render: (h, params) => {
                      ...
                      // return h('span', {}, tex)
                      let tex=params.row.carBrandName
                      let tex1=params.row.carModelName
                      return h('div',[
