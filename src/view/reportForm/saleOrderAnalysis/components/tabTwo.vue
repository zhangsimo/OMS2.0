<template>
  <section class="con-box">
    ...
    >
      ...
      <vxe-table-column show-overflow="tooltip" field="quality" title="品质" width="70" fixed="left"></vxe-table-column>
      <vxe-table-column show-overflow="tooltip" field="partBrand" title="品牌" width="80" fixed="left"></vxe-table-column>
      <vxe-table-column show-overflow="tooltip" field="partTypeName" title="配件一级分类" width="100"></vxe-table-column>
      <vxe-table-column show-overflow="tooltip" field="partTypeNameS" title="配件二级分类" width="100"></vxe-table-column>
      <vxe-table-column show-overflow="tooltip" field="carBrandName" title="厂牌" width="80"></vxe-table-column>
...
<!--      <vxe-table-column show-overflow="tooltip" field="" title="实物码" width="100"></vxe-table-column>-->
      ...
      <vxe-table-column show-overflow="tooltip" field="enterAmt" remote-sort title="实际成本金额" width="110"></vxe-table-column>
    </vxe-table>
    <Page
      class-name="page-con"
      :current="page.num"
