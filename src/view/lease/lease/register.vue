      ...
      <div class="oper-top flex">
        <div class="wlf">
          ...
          <div class="db">
            ...
            <Button class="mr10 w90" v-show="jin" @click="warning"><span class="center"><Icon custom="iconfont iconjinzhijinyongicon icons" />禁用</span></Button>
            <Button class="mr10 w90" v-show="qi" @click="JinOrQi2"><span class="center"><Icon custom="iconfont iconqiyongicon icons" />启用</span></Button>
          </div>
