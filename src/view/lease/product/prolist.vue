      ...
      <div class="oper-top flex">
        <div class="wlf">
          <div class="db">
            ...
            <Button type="warning" @click="search" class="mr10 w90"><i class="iconfont mr5 iconchaxunicon"></i>查询</Button>
            <Button class="mr10 w90" @click="addPro"><Icon type="md-add"/> 新增</Button>
            <Button class="mr10 w90" @click="editPro"><i class="iconfont mr5 iconbianjixiugaiicon"></i>修改</Button>
            <Button @click="linkProMadel" class="mr10"><i class="iconfont mr5 iconchakanchanpinicon"></i>相关产品资源</Button>
          </div>
        </div>
      </div>
    </section>
    <section class="con-box">
      <Table class="table-highlight-row" @on-current-change="selectTabelData" size="small" highlight-row :loading="loading" border :stripe="true" :columns="columns" :data="tbdata"></Table>
        ...
        <Split v-model="split1" min="400" max="500">
          <div slot="left" class="lease-model-left">
            <div class="model-left-hd flex">
              <Button @click="getLeasesaveProductFun" class="mr10 w90"><i class="iconfont mr5 iconbaocunicon"></i>保存</Button>
              ...
              <Button type="warning" @click="getLeasesaveProductFun" class="w90"><i class="iconfont mr5 iconchaxunicon"></i>查询</Button>
            </div>
          ...
          <div slot="right" class="lease-model-right">
            <div class="model-left-hd flex">
              ...
              <Button type="default" @click='linkModal = false' class="w90"><Icon type="md-close" />取消</Button>
            </div>
            <Table height="347" @on-selection-change="selectDetailFun" size="small" :loading="linkloading" border :stripe="true" :columns="columns2" :data="tbdata2"></Table>
          </div>
        </Split>
      </div>
      <div slot='footer'>
...
<script>
  import './lease.less'
  import {getLeaseProlist,saveProduct,getProductDetail,deleteAndChange,getLeasesaveProduct} from '../../../api/lease/leaseApi'
